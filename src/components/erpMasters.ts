...
export const initialQuotes: Quote[] = [
  ...
  // Same website enquiry as LD-1048 (its other quote, QT-2026-0844, is the separate new AFM
  // probe station purchase) — Nova also asked SPM to verify the AFM probe station it already
  // owns (CI-0116) while it was in our lab for its customer audit.
  { id: "QT-2026-0850-R1", number: "QT-2026-0850", revision: 1, customer: "Nova Instruments", contact: "Rhea Mehta", customerGstin: "29AABCN4106D1Z7", customerState: "Karnataka", billingAddress: "12, HAL 2nd Stage, Indiranagar, Bengaluru, Karnataka 560038", shippingAddress: "Materials Lab, Nova Instruments, Bengaluru, Karnataka 560038", paymentTerms: "Net 30", quoteDate: "2026-09-11", validUntil: "2026-09-25", lead: "LD-1048", owner: "Arun Kumar", subject: "Annual verification — AFM probe station", status: "Accepted", sentAt: "11 Sep 2026", acceptedPo: "NI/PO/2026/402", acceptedDate: "12 Sep 2026", items: [{ id: "nova-svc-1", item: "AFM Probe Station — Annual verification", description: "Annual verification and certification, in-lab", hsn: "9987", quantity: 1, unit: "Job", rate: 42000, discount: 0, gst: 18, inStock: false }], terms: DEFAULT_TERMS, deliveryPeriod: "In-lab, 3–5 working days", warranty: "Certificate valid 12 months" },
];
...
export type Vendor = { name: string; contact: string; phone: string; gstin: string; state: string; address: string; paymentTerms: string; tdsSection: string; tdsRate: number };
...
export const vendorMaster: Vendor[] = [
  { name: "Precision Systems India", contact: "Vikram Joshi", phone: "+91 98220 55671", gstin: "27AACCP1234F1Z8", state: "Maharashtra", address: "Plot 22, Bhosari MIDC, Pune, Maharashtra 411026", paymentTerms: "Net 30", tdsSection: "194C", tdsRate: 1 },
  { name: "Nanotech Supplies", contact: "Divya Krishnan", phone: "+91 98410 66782", gstin: "33AAGCN7781K1ZP", state: "Tamil Nadu", address: "5, Ambattur Industrial Estate, Chennai, Tamil Nadu 600058", paymentTerms: "Net 15", tdsSection: "—", tdsRate: 0 },
  { name: "Bengaluru Lab Spares", contact: "Rakesh Gowda", phone: "+91 98450 33219", gstin: "29AAFCB9012L1ZR", state: "Karnataka", address: "17, Rajajinagar Industrial Town, Bengaluru, Karnataka 560010", paymentTerms: "Net 30", tdsSection: "194C", tdsRate: 1 },
  { name: "Optika Instruments", contact: "Farah Sheikh", phone: "+91 99250 44187", gstin: "24AABCO4455N1ZV", state: "Gujarat", address: "9, GIDC Vatva, Ahmedabad, Gujarat 382445", paymentTerms: "Net 45", tdsSection: "194Q", tdsRate: 0.1 },
];
