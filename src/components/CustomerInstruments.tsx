...
export default function CustomerInstrumentsPanel({ customer, openJob }: { customer: string; openJob?: (jobId: string) => void }) {
  ...
  return <section className="ci-page">
    ...
    <div className="erp-table-shell"><table className="erp-data-table ci-register"><colgroup><col style={{ width: 44 }} /><col style={{ width: "21%" }} /><col style={{ width: "16%" }} /><col style={{ width: "22%" }} /><col style={{ width: "14%" }} /><col style={{ width: "17%" }} /><col style={{ width: "10%" }} /></colgroup><thead><tr>
